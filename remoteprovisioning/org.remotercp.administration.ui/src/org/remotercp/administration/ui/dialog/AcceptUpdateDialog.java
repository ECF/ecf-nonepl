...
import org.remotercp.administration.ui.internal.AdministrationActivator;
	...
	private void createContent(final Shell shell) {
...

		{
			...
			labels.setLayout(new GridLayout(2, false));
			{
				...
				ImageDescriptor image = AdministrationActivator
						...
						display.asyncExec(new Runnable() {
							public void run() {
								if (!message.isDisposed()) {
									...
									message.setText("Your application will be updated within the next "
											+ timeToLive
											+ " sec. "
											+ "\n\n"
