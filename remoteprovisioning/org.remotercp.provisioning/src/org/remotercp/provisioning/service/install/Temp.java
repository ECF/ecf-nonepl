...
//	 List<IInstallFeatureOperation> installOperations = new
...
//	
//	 /**
//	 * This method performs the installation for the given install commands
//	 and
//	 * records errors occurred during the install operations.
//	 *
//	 * In addition to that this method calls the uninstall operation, if an
//	 old
...
//	 */
//	 List<IStatus> statusCollector = new ArrayList<IStatus>();
//	 List<IOperation> unconfigAndUninstallOperations = new
//	 ArrayList<IOperation>();
//	 Map<IConfiguredSite, IFeature> featuresToDeleteFromDisk = new
//	 HashMap<IConfiguredSite, IFeature>();
//	 if (!lock.isLocked()) {
//	 try {
//	 lock.lock();
//	
...
//	
//	 IOperation unconfigAndUninstallOperation = ((OperationFactory)
//	 OperationsManager
//	 .getOperationFactory())
...
//	 for (IOperation unconfigAndUninstallOperation :
//	 unconfigAndUninstallOperations) {
//	 IFeature feature = ((IUnconfigureAndUninstallFeatureOperation)
//	 unconfigAndUninstallOperation)
//	 .getFeature();
//	
//	 try {
...
//	 * version, label and URL to perform uninstall operations. In order to
//	 allow
...
//	 List<IFeatureReference> featureReferences = new
//	 ArrayList<IFeatureReference>();
...
//	 *
//	 * @return The status whether client has accepted (Status.OK) the update
//	 or
...
//	
//	 /**
//	 * This method will install the provided features in user's RCP
//	 application.
//	 */
...
//	 * @throws CoreException
//	 */
//	 private IConfiguredSite getLocalConfiguredSiteForFeature(String
//	 featureId)
//	 throws CoreException {
...
//	
//	 /**
//	 * An update is a mix of uninstall old feature and install the new
//	 feature.
...
//	
//	 /*
//	 * This method will create a serializable status and log the status
//	 message.
//	 */
