...
public interface IRemoteServiceContainerAdapter extends IAdaptable {
	 ...
	 */
	public IRemoteServiceReference[] getRemoteServiceReferences(ID[] idFilter, String clazz, RegularExpression filter) throws InvalidSyntaxException;
	 ...
	 * @since 3.0
	 */
	public IRemoteServiceReference[] getRemoteServiceReferences(ID target, String clazz, RegularExpression filter) throws InvalidSyntaxException, ContainerConnectException;
	 ...
	 * @since 3.0
	 */
	public Future asyncGetRemoteServiceReferences(ID[] idFilter, String clazz, RegularExpression filter);
	 ...
	 * @since 3.0
	 */
	public Future asyncGetRemoteServiceReferences(ID target, String clazz, RegularExpression filter);
	 ...
	 * @since 3.0
	 */
	public IRemoteServiceReference[] getAllRemoteServiceReferences(String clazz, RegularExpression filter) throws InvalidSyntaxException;
	 ...
	 */
	public IRemoteFilter createRemoteFilter(RegularExpression filter) throws InvalidSyntaxException;
