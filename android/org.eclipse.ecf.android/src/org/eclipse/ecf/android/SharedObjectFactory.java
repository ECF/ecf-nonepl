...
public class SharedObjectFactory implements ISharedObjectFactory {
	...
	private static void trace(String msg) {
		//  TODO [pierre].trace(Activator.PLUGIN_ID, msg);
	}

	private static void dumpStack(String msg, Throwable e) {
		//  TODO [pierre].catching(Activator.PLUGIN_ID, SharedObjectDebugOptions.EXCEPTIONS_CATCHING, SharedObjectFactory.class, "dumpStack", e); //$NON-NLS-1$
	}
...
//		trace("createSharedObject(" + desc + "," + Trace.getArgumentsString(args) + ")"); // TODO [pierre]
		if (desc == null)
