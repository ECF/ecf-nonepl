...
public class ContainerMessage implements Serializable  {
	...
	public Serializable getData() {
		return message.getData().getSerializable(String.valueOf(sequence));
	}
	...
	public void setData(Serializable data) {
		this.data = data;
		message.getData().putSerializable( String.valueOf(getSequence()), data);
	}
	...
	protected ContainerMessage(ID from, ID to, long seq, Serializable data) {
		...
		b.putSerializable(String.valueOf(seq), data);
		message.setData(b);
	}
