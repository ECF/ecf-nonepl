...
public interface IDiscoveryConfig {
	...
	/**
	 * This service registration property indicates that this service is to be
	 * implicitly published by ZooDiscovery.
	 * <p>
	 */
	String ZOODISCOVERY_ADVERTISE_AUTO = "zoodiscovery.advertise.auto"; //$NON-NLS-1$
