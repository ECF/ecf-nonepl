 ...
 * 
 */
public class DefaultDiscoveryConfig extends DiscoveryContainerConfig implements
		IDiscoveryConfig {
	...
	public DefaultDiscoveryConfig() {
		super(IDFactory.getDefault().createGUID());

		// all the rest are optional for you and are(or will be at runtime)
		// taken care of.		
		this.props.put(ZOOKEEPER_DATADIR, DATADIR_DEFAULT);
		this.props.put(ZOOKEEPER_DATALOGDIR, DATALOGDIR_DEFAULT);
		this.props.put(ZOOKEEPER_CLIENTPORT, CLIENT_PORT_DEFAULT);
		this.props.put(ZOOKEEPER_TICKTIME, TICKTIME_DEFAULT);
		this.props.put(ZOOKEEPER_INITLIMIT, INITLIMIT_DEFAULT);
		this.props.put(ZOOKEEPER_SYNCLIMIT, SYNCLIMIT_DEFAULT);
		this.props.put(ZOOKEEPER_SERVER_PORT, SERVER_PORT_DEFAULT);
		this.props.put(ZOOKEEPER_ELECTION_PORT, ELECTION_PORT_DEFAULT);
		this.props.put("preAllocSize", 1); //$NON-NLS-1$
