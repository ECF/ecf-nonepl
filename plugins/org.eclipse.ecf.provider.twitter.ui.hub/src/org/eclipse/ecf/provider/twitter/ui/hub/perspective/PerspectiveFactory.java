package org.eclipse.ecf.provider.twitter.ui.hub.perspective;
...
//		
		//new
		IFolderLayout messages = layout.createFolder("messageFolder", IPageLayout.RIGHT, 0.25f, FriendsViewPart.VIEW_ID);
