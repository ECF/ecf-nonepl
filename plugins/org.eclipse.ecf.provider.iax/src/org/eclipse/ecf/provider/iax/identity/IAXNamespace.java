 ...
 *
 */
public class IAXNamespace extends Namespace {

	private static final long serialVersionUID = 1235788855435011811L;
	public static final String SCHEME = "iax";
	public static final String NAME = "ecf.namespace.iax";
	...
	public ID createInstance(Object[] parameters) throws IDCreateException {
		...
		return new IAXID(this, (String) parameters[0]);
	}
