...
package org.eclipse.ecf.provider.jms.weblogic.application;
 ...
 */
public class WeblogicJMSServer implements IApplication {

	private WeblogicJMSServerContainer serverContainer = null;
	...
	public Object start(IApplicationContext context) throws Exception {
		...
		if (args.length < 1) {
			...
			synchronized (this) {
				serverContainer = new WeblogicJMSServerContainer(config);
