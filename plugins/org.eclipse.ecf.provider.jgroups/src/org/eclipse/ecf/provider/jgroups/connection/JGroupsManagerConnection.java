...
public class JGroupsManagerConnection extends AbstractJGroupsConnection {
	...
	public class Client implements ISynchAsynchConnection {
		 ...
		 * 
		 * @see
		 * org.eclipse.ecf.provider.comm.IConnection#addListener(org.eclipse
		 * .ecf.provider.comm.IConnectionListener)
		 */
		 ...
		 * 
		 * @see
		 * org.eclipse.ecf.provider.comm.IConnection#connect(org.eclipse.ecf
		 * .core.identity.ID, java.lang.Object, int)
		 */
		public Object connect(ID targetID, Object data, int timeout)
				throws ECFException {
			throw new ECFException("Server cannot connect");
		 ...
		 * 
		 * @see
		 * org.eclipse.ecf.provider.comm.IConnection#removeListener(org.eclipse
		 * .ecf.provider.comm.IConnectionListener)
		 */
