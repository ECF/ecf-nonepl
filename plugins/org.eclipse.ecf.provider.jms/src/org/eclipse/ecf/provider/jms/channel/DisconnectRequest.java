...
public class DisconnectRequest implements Serializable, ECFMessage, SynchRequest {
	...
	public DisconnectRequest(String jmsTopicClientID, ID clientID, ID targetID, Serializable data) {
