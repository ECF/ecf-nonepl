...
public class VoiceCallInterface {
	...
	public static String getJid(String jid) {
		return jid.substring(0, jid.indexOf("/") < 0 ? jid.length() : jid.indexOf("/"));
	}

	public String changeActiveCallerID(String jid) {
		jid = getJid(jid);
		activeCallerID = jid;
	...
	private boolean isActiveCallMute;
	...
	public VoiceCallInterface() {
		// TODO Auto-generated constructor stub
	}

	public static VoiceCallInterface getDefault(GoogleCallSessionContainerAdapter adapter) {
		if (self == null) {
	...
	public void muteActiveCall() {
		isActiveCallMute = true;
		voiceThread.muteActiveCall();
	}

	public void unmuteActiveCall() {
		isActiveCallMute = false;
	...
	public boolean isCallActive() {
		...
		return !(activeCallerID.trim().length() == 0 || activeCallerID.trim().equals(""));
	}
