...
public class Messages extends NLS {
	private static final String BUNDLE_NAME = "org.eclipse.ecf.internal.provider.google.ui.messages"; //$NON-NLS-1$

	public static String GoogleConnectWizardPage_WIZARD_TITLE;
	public static String GoogleConnectWizardPage_WIZARD_DESCRIPTION;
	...
	public static String GoogleConnectWizardPage_WIZARD_PAGE_TITLE;
	public static String GoogleConnectWizardPage_WIZARD_PAGE_USERID;
	public static String GoogleConnectWizardPage_WIZARD_PAGE_STATUS;
	...
	public static String GoogleConnectWizardPage_WIZARD_PAGE_DESCRIPTION;
	...
	public static String GoogleConnectWizardPage_WIZARD_PAGE_TEMPLATE;
	public static String GoogleConnectWizardPage_WIZARD_PAGE_PASSWORD;
	...
	public static String GoogleConnectWizard_WIZARD_TITLE;

	public static String GOOGLE_ENABLE_OFF_THE_RECORD;

	public static String GOOGLE_DISABLE_OFF_THE_RECORD;
