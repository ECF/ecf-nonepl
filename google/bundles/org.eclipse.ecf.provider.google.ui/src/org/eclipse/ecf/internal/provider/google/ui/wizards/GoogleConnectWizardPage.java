...
import org.eclipse.ecf.internal.provider.google.ui.Activator;
import org.eclipse.ecf.internal.provider.google.ui.Messages;
...
public class GoogleConnectWizardPage extends WizardPage {

	protected Combo connectText;
	...
	protected GoogleConnectWizardPage() {
		super(""); //$NON-NLS-1$
		setTitle(Messages.GoogleConnectWizardPage_WIZARD_TITLE);
		setDescription(Messages.GoogleConnectWizardPage_WIZARD_DESCRIPTION);
		setImageDescriptor(SharedImages
				.getImageDescriptor(SharedImages.IMG_CHAT_WIZARD));
		setPageComplete(false);
	}

	GoogleConnectWizardPage(String usernameAtHost) {
		this();
	...
	private static final String PAGE_SETTINGS = GoogleConnectWizardPage.class
			.getName();
